...
const SectionCTA = () => {
  ...
  const content = {
    fr: {
      ...
      headline: ["Votre prochaine démarche fiscale", "commence par une simple question."],
      subline: "Rejoignez les citoyens, artisans et entreprises qui simplifient déjà leurs obligations fiscales avec MboaGov Fiscal — disponible 24/7, partout au Cameroun.",
      btnStart: "Commencer maintenant",
      btnDemo: "Voir une démonstration",
      perks: [
    ...
    en: {
      ...
      headline: ["Your next tax step", "begins with a simple question."],
      subline: "Join the citizens, artisans and businesses already simplifying their tax obligations with MboaGov Fiscal — available 24/7, across Cameroon.",
      btnStart: "Start now",
      btnDemo: "View a demonstration",
      perks: [
