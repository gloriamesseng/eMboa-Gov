      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16 lg:mb-20 reveal-up">
          <div className="inline-flex items-center gap-3 mb-6">
            ...
            <span className="text-xs md:text-sm font-bold tracking-widest uppercase text-brand-green" style={{ letterSpacing: '.25em' }}>Pour qui&nbsp;?</span>
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-brand-blue tracking-tight leading-[1.15] mb-6">
            Conçu pour chaque contribuable camerounais.
          </h2>
          <p className="text-base md:text-lg text-brand-muted font-medium leading-relaxed">
            Quel que soit votre niveau de connaissance fiscale, MboaGov s'adapte à votre réalité quotidienne pour vous offrir un accompagnement sur-mesure.
          </p>
        </div>
          ...
          {TARGET_GROUPS.map((group, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 p-8 flex flex-col justify-center opacity-0 group-hover:opacity-100 transition-all duration-500 translate-y-6 group-hover:translate-y-0">
                <h3 className="text-lg font-bold text-white mb-5 border-b border-white/20 pb-4">La réalité {group.id === 'liberal' ? 'libérale' : `de l'${group.id === 'pme' ? 'PME' : 'artisan'}`}</h3>
